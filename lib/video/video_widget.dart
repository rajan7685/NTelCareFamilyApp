...
class _VideoWidgetState extends State<VideoWidget> {
                                                                                      ...
                                                                                      child: Column(
                                                                                        ...
                                                                                        children: [
                                                                                          Row(
                                                                                            ...
                                                                                            children: [
                                                                                              Text(
                                                                                                "Camera" + " " + snapshot.data[index]["CameraID"],
                                                                                          ...
                                                                                          Row(
                                                                                            ...
                                                                                            children: [
                                                                                              Text(
                                                                                                snapshot.data[index]["CameraName"],
                                                                                                style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                                                      fontFamily: 'Poppins',
  ...
  fetchCamera() async {
    final ApiCallResponse cameras =
        await CameraList.call(token: FFAppState().Token);
    return cameras.jsonBody['Array'];
  }
}
